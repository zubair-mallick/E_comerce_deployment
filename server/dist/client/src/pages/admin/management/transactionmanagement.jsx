      ...
      <main className="product-management">
       {isLoading ? <Skeleton /> : <>
        <section style={{
          ...
          {orderItems.map((i) => (<ProductCard key={i._id} name={i.name} photo={i.photo} productId={i.productId} _id={i._id} quantity={i.quantity} price={i.price}/>))}
        </section>
...
const ProductCard = ({ name, photo, price, quantity, productId, }) => (<div className="transaction-product-card">
