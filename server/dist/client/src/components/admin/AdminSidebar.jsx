...
const AdminSidebar = () => {
    ...
    return (<>
      ...
      <aside style={phoneActive
        ...
        {phoneActive && (<button id="close-sidebar" onClick={() => setShowModal(false)}>
            Close
          </button>)}
      </aside>
    </>);
};
const DivOne = ({ location }) => (<div>
    <h5>Dashboard</h5>
    <ul>
...
const Li = ({ url, text, location, Icon }) => (<li style={{
