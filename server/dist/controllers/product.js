...
export const updateProduct = TryCatch(async (req, res, next) => {
    ...
    if (photo) {
        ...
        cloudinary.uploader.destroy(publicId, { invalidate: true, resource_type: "image" }, function (error, result) {
            if (result) {
...
export const getAllProducts = TryCatch(async (req, res, next) => {
    const { search, sort, category, price, minPrice, // Added minPrice to the destructured query
    page: pageFromQuery, limit: limitFromQuery, } = req.query;
